...
<head>
    ...
    <title>Sewer Connect | Libato, San Juan, Batangas</title>
    ...
    <main>
        <div class="container">
            <section id="home" class="tab-content">
                ...
                <ul>
                    <li>Ang website na ito ay ginawa para tulungan ang mga mananahi at kliyente na makipag-ugnayan nang mas madali.</li>
            ...
            <section id="sample-photos" class="tab-content">
                ...
                <div class="photo-category">
                    ...
                    <div class="photo-grid" id="materials-grid"></div>
                </div>
                <div class="photo-category">
                    <h3>Proseso ng Paggawa</h3>
                    <div class="photo-grid" id="process-grid"></div>
                </div>
                <div class="photo-category">
                    <h3>Mga Tapos na Produkto</h3>
                    <div class="photo-grid" id="final-product-grid"></div>
                </div>
                <div class="photo-category">
                    <h3>Mga Video</h3>
